...
features:
  - title: Manga and light novels, one library
    details: Both are first-class. Same library, same chrome, same settings, with a chip to narrow to one or see them together, rather than a second app bolted onto the first.
  ...
  - title: One series, however many sources
    details: A novel followed across two sites, or a manga across four, is one card with a source switcher. Merge and split by hand when the titles do not match, and read the whole group as one chapter list.
  ...
  - title: Find anything in one query
    details: Search a field, compare chapter counts and dates, combine terms and exclude them. One grammar, the same answer whichever library you are in.
    icon: <svg viewBox="0 -960 960 960" width="24" height="24" fill="var(--vp-c-purple-2)" xmlns="http://www.w3.org/2000/svg"><path d="M784-120 532-372q-30 24-69 38t-83 14q-109 0-184.5-75.5T120-580q0-109 75.5-184.5T380-840q109 0 184.5 75.5T640-580q0 44-14 83t-38 69l252 252-56 56ZM380-400q75 0 127.5-52.5T560-580q0-75-52.5-127.5T380-760q-75 0-127.5 52.5T200-580q0 75 52.5 127.5T380-400Z"/></svg>
    link: /docs/library-search
    linkText: Search syntax
---
